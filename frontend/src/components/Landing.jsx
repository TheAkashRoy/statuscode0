...
const Landing = () => {
  ...
  return (
   ...
   <button className=' text-sm px-4 py-1 rounded-full bg-white font-semibold'>Buy</button>
   <button className=' text-sm bg-white font-semibold px-4 py-1 rounded-full'>Sell</button>
   {
    isAuthenticated?(
